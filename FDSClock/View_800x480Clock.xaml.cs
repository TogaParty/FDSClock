...
namespace FDSClock
{
    ...
    {
        string nowWeatherPath = "Assets/Images/SevereWeather_Light.png";
        string nowWeatherShadowPath = "Assets/Images/SevereWeather_Dark.png";

        string todayWeatherPath = "Assets/Images/SevereWeather_Light.png";
        string todayWeatherShadowPath = "Assets/Images/SevereWeather_Dark.png";

        string tomorrowWeatherPath = "Assets/Images/SevereWeather_Light.png";
        string tomorrowWeatherShadowPath = "Assets/Images/SevereWeather_Dark.png";
        ...
        {
            nowWeatherPath = "Assets/Images/Sunny_Light.png";
            nowWeatherShadowPath = "Assets/Images/Sunny_Dark.png";

            todayWeatherPath = "Assets/Images/Cloudy_Light.png";
            todayWeatherShadowPath = "Assets/Images/Cloudy_Dark.png";

            tomorrowWeatherPath = "Assets/Images/SevereWeather_Light.png";
            tomorrowWeatherShadowPath = "Assets/Images/SevereWeather_Dark.png";
        }
    }
}
